    ...
    , facteur_zoom(1)
{
    ...
    connect(recorder,
            ...
            this,
            &Pageprincipal::Sienregistrementchange);
...
void Pageprincipal::essai()
{
    ...
    for (int i = 0; i < headers.size(); ++i) {
        ...
        if (h == QString("fréquence d'échantillonnage")
            || h == QString("frequence d'echantillonnage")) {
            idxFs = i;
